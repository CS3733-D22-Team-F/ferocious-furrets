...
public class LabDAOImpl implements IRequestDAO {
  ...
  public void initTable(File file) throws SQLException, IOException {
    DatabaseManager.getInstance().dropTableIfExist("labRequest");
    DatabaseManager.getInstance()
        .runStatement("CREATE TABLE labRequest (reqID varchar(16) PRIMARY KEY, type varchar(16))");
  ...
  public void add(ArrayList<String> fields) throws SQLException {
    ...
    DatabaseManager.getInstance().runStatement(generateInsertStatement(labRequestFields));
  }
  ...
  public ResultSet get() throws SQLException {
    return DatabaseManager.getInstance().runQuery("SELECT * FROM LABREQUEST");
  }
