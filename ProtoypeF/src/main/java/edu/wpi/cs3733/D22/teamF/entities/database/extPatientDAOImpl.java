...
public class extPatientDAOImpl implements IRequestDAO {
  public void initTable(File file) throws SQLException, IOException {
    DatabaseManager.dropTableIfExist("externalPatientRequest");
  ...
  public void addInit(ArrayList<String> fields) throws SQLException {
    ...
    DatabaseManager.runStatement(generateInsertStatement(extPatientRequest));
  }
  ...
  public ResultSet get() throws SQLException {
    return DatabaseManager.runQuery("SELECT * FROM EXTERNALPATIENTREQUEST");
  }
