...
import edu.wpi.cs3733.D22.teamF.boundary.AGlobalMethods;
import edu.wpi.cs3733.D22.teamF.boundary.Map.MapComponents.MapIconModifier;
import edu.wpi.cs3733.D22.teamF.boundary.Map.MapComponents.MapLocationModifier;
import edu.wpi.cs3733.D22.teamF.boundary.Map.MapComponents.MapPopUp;
import edu.wpi.cs3733.D22.teamF.boundary.Map.MapComponents.MapTableHolder;
...
public class mapPageController implements Initializable {
  ...
  public void switchToHome(ActionEvent event) throws IOException {
    StageManager.getInstance().setDisplayNoViews("views/homePage.fxml");
  }
